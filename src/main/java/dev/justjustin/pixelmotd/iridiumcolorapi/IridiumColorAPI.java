package dev.justjustin.pixelmotd.iridiumcolorapi;

import com.google.common.collect.ImmutableMap;
import dev.justjustin.pixelmotd.iridiumcolorapi.patterns.GradientPattern;
import dev.justjustin.pixelmotd.iridiumcolorapi.patterns.IridiumPattern;
import dev.justjustin.pixelmotd.iridiumcolorapi.patterns.RainbowPattern;
import dev.justjustin.pixelmotd.iridiumcolorapi.patterns.SolidPattern;
...
public class IridiumColorAPI {
     ...
     * @since 1.0.2
     */
    private static final List<IridiumPattern> PATTERNS = Arrays.asList(
            new GradientPattern(),
            new SolidPattern(),
            new RainbowPattern()
    );
    ...
    public static String process(@NotNull String string) {
        for (IridiumPattern pattern : PATTERNS) {
